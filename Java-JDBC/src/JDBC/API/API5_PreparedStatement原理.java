...
public class API5_PreparedStatement原理
    {
        /**
         * 此时预编译未开启，要在URL中添加useServerPrepStmts=true到最后
         * @throws Exception
         */
        @Test
         ...
         *   手动开启预编译useServerPrepStmts=true
         ...
         */
        @Test
        public void testPreparedStatementOpen() throws Exception
            {
                //2.获取链接对象
